      ...
      <main className="relative container mx-auto max-w-7xl z-10 px-6 min-h-[calc(100vh_-_64px_-_108px)] mb-12 flex-grow">
        <section className="w-full flex flex-col items-center lg:px-16 mt-12 gap-6">
          <div className="text-center max-w-xl">
            <h1 className="mb-2 font-bold text-4xl">TeraUI Figma Kit</h1>
            <h5 className="text-default-500 text-lg">
              A Figma file that contains the basis of the TeraUI design system to help you design
              your applications.
            </h5>
          </div>
          ...
          <iframe
            ...
            height="600"
            src="https://embed.figma.com/file/1267584376234254760/hf_embed?community_viewer=true&embed_host=teraui"
            title="TeraUI Figma Kit"
            width="800"
          />
