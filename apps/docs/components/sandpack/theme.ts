...
export const terauiTheme: SandpackTheme = {
  colors: {
    surface1: "hsl(var(--teraui-code-background))",
    surface2: "hsl(var(--teraui-code-background))",
    surface3: "hsl(0, 0%, 15%)",
    disabled: "#A258DF2b",
    base: "hsl(var(--teraui-code-background))",
    clickable: "#ffffff",
    hover: "#A258DF",
    accent: "#A258DF",
    error: "#811e18",
