...
import {Avatar, AvatarProps, Button, Spacer, Tooltip} from "@tera-ui/react";
...
const supportAccounts = [
  {
    ...
    description: "Sponsor the TeraUI maintainers.",
    icon: <OpenCollectiveIcon className="text-pink-500" />,
    href: "https://opencollective.com/teraui",
    isExternal: true,
  },
  {
    title: "Patreon",
        ...
        <div>
          <div className={titleWrapper({class: "text-center items-center"})}>
            <div className="flex md:inline-flex flex-col md:flex-row items-center">
              <h1 className={title({size: "lg"})}>Support TeraUI&nbsp;</h1>
              <HeartBoldIcon
          ...
          >
            Using TeraUI in a profit-making product, as a freelancer, or for fun projects? Your
            contributions will help to make TeraUI better.
          </p>
          <Spacer y={12} />
          <FeaturesGrid
            classNames={{
