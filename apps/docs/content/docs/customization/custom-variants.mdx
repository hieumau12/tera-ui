...
reference. Go [here](https://github.com/hieumau12/nextui-tera/blob/feat/v2/packages/core/theme/src/components/button.ts) to view the styles source code.
...
reference. Go [here](https://github.com/hieumau12/nextui-tera/blob/feat/v2/packages/core/theme/src/components/input.ts) to view the styles source code.
