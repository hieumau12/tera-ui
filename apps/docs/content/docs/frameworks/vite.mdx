---
title: Vite
description: How to use TeraUI with Vite
---
...
To use TeraUI in your Vite project, you need to follow the following steps:

<Steps>

### Installation

In your Vite React project, run one of the following command to install TeraUI:
...
Go to the src directory and inside `main.jsx` or `main.tsx`, wrap `TeraUIProvider` around App:
