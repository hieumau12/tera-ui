---
title: Astro
description: How to use TeraUI with Astro
---
...
To use TeraUI in your Astro project, you need to follow the following steps:

<Steps>

### Installation

In your Astro project, run one of the following command to install TeraUI:
...
Now you can import TeraUI components and use them in your Astro project:
...
some functionalities of TeraUI components may not work properly.
