...
<Blockquote
 color="default"
>
  Please visit the <Link href="https://github.com/hieumau12/tera-ui/releases/tag/v2.0.0" showAnchorIcon isExternal>Release Notes</Link> for more information about the new features and breaking changes.
</Blockquote>
