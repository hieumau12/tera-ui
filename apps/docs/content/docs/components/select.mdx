...
TeraUI exports 3 select-related components:
...
<ImportTabs
  commands={{
    main: 'import {Select, SelectSection, SelectItem} from "@tera-ui/react";',
    individual: 'import {Select, SelectSection, SelectItem} from "@tera-ui/select";',
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @tera-ui/use-infinite-scroll",
    yarn: "yarn add @tera-ui/use-infinite-scroll",
    pnpm: "pnpm add @tera-ui/use-infinite-scroll",
  }}
/>
