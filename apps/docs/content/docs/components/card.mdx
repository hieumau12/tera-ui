...
TeraUI exports 4 card-related components:
...
<ImportTabs
  commands={{
    main: 'import {Card, CardHeader, CardBody, CardFooter} from "@tera-ui/react";',
    individual: 'import {Card, CardHeader, CardBody, CardFooter} from "@tera-ui/card";',
  }}
/>
...
You can use other TeraUI components inside the card to compose a more complex card.
