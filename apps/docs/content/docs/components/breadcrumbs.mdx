...
TeraUI exports 2 breadcrumb-related components:
...
<ImportTabs
  commands={{
    main: 'import {Breadcrumbs, BreadcrumbItem} from "@tera-ui/react";',
    individual: 'import {Breadcrumbs, BreadcrumbItem} from "@tera-ui/breadcrumbs";',
  }}
/>
