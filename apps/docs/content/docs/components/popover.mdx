...
TeraUI exports 3 popover-related components:
...
<ImportTabs
  commands={{
    main: 'import {Popover, PopoverTrigger, PopoverContent} from "@tera-ui/react";',
    individual: 'import {Popover, PopoverTrigger, PopoverContent} from "@tera-ui/popover";',
  }}
/>
