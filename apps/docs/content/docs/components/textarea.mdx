...
<ImportTabs
  commands={{
    main: 'import {Textarea} from "@tera-ui/react";',
    individual: 'import {Textarea} from "@tera-ui/input";',
  }}
/>
...
> **Note**: TeraUI `Textarea` also supports native events like `onChange`, useful for form libraries
