...
<ImportTabs
  commands={{
    main: 'import {RadioGroup, Radio} from "@tera-ui/react";',
    individual: 'import {RadioGroup, Radio} from "@tera-ui/radio";',
  }}
/>
...
> **Note**: TeraUI `Radio` also supports native events like `onChange`, useful for form libraries
