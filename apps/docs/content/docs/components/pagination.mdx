...
TeraUI exports 3 pagination-related components:
...
<ImportTabs
  commands={{
    main: 'import {Pagination, PaginationItem, PaginationCursor} from "@tera-ui/react";',
    individual:
      'import {Pagination, PaginationItem, PaginationCursor} from "@tera-ui/pagination";',
  }}
/>
