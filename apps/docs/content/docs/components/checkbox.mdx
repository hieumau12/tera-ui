...
<ImportTabs
  commands={{
    main: 'import {Checkbox} from "@tera-ui/react";',
    individual: 'import {Checkbox} from "@tera-ui/checkbox";',
  }}
/>
...
> **Note**: TeraUI `Checkbox` also supports native events like `onChange`, useful for form libraries
