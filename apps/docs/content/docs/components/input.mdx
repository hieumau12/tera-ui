...
<ImportTabs
  commands={{
    main: 'import {Input} from "@tera-ui/react";',
    individual: 'import {Input} from "@tera-ui/input";',
  }}
/>
...
> **Note**: TeraUI `Input` also supports native events like `onChange`, useful for form libraries
