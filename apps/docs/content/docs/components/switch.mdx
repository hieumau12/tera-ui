...
<ImportTabs
  commands={{
    main: 'import {Switch} from "@tera-ui/react";',
    individual: 'import {Switch} from "@tera-ui/switch";',
  }}
/>
...
> **Note**: TeraUI `Switch` also supports native events like `onChange`, useful for form libraries
