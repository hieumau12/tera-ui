...
TeraUI exports 2 accordion-related components:
...
<ImportTabs
  commands={{
    main: 'import {Accordion, AccordionItem} from "@tera-ui/react";',
    individual: 'import {Accordion, AccordionItem} from "@tera-ui/accordion";',
  }}
/>
