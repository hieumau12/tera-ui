...
TeraUI exports 2 checkbox-related components:
...
<ImportTabs
  commands={{
    main: 'import {CheckboxGroup, Checkbox} from "@tera-ui/react";',
    individual: 'import {CheckboxGroup, Checkbox} from "@tera-ui/checkbox";',
  }}
/>
