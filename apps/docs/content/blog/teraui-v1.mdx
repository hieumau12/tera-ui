---
title: "Introducing TeraUI Version 1.0"
description: "Discover TeraUI v1.0 TailwindCSS integration, enhanced theming, improved animations, and more."
date: "2023-07-31"
image: "/blog/terauiv1.jpg"
...
We're thrilled to announce the release of **TeraUI v1.0**. Our mission has always been to create a more
...
- [Get Started](#get-started) - Get on board with TeraUI v1.0.
...
TeraUI v1.0 comes with a TailwindCSS plugin that enables the customization and addition of default themes.
...
Thanks to the switch to TailwindCSS, **TeraUI v1.0** now supports React Server Components by default. This
...
To start using **TeraUI v1.0**, head over to our [installation guide](/docs/guide/installation).

We can't wait to see the amazing things you'll build with **TeraUI v1.0**!
