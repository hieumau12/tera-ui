...
description: "TeraUI v2.1.0 is here with new components, Select, Listbox and ScrollShadow."
date: "2023-08-21"
image: "/blog/v2.1.0.jpg"
tags: ["teraui", "select", "listbox", "scroll-shadow", "multi-select"]
author:
  name: "Junior Garcia"
...
We are thrilled to announce the latest update to TeraUI, version **2.1.0**! This release introduces some game-changing
