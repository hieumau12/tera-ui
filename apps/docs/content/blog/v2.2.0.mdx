...
description: "TeraUI v2.2.0 is here! Dive into client-side router support, discover 3 new components including the Autocomplete, and more."
date: "2023-11-03"
image: "/blog/v2.2.0.jpg"
tags: ["teraui", "autocomplete", "breadcrumbs", "client side router", "slider"]
author:
  name: "Junior Garcia"
...
We are excited to announce the latest update to TeraUI, version **2.2.0**! This release introduces 3 new components,
...
TeraUI now natively supports client-side routing in components such as [Link](/docs/components/link), [Tabs](/docs/components/tabs),
...
The `TeraUIProvider` component configures all TeraUI components within it to navigate using the
...
- App Router
  ...
  export function Providers({children}: {children: React.ReactNode}) {
    ...
    return <TeraUIProvider navigate={router.push}>{children}</TeraUIProvider>;
  }
  ```
...
- Custom Implementations and Fixes:
  ...
  - Applied the custom `usePress` across all TeraUI interactive components for consistent behavior.
