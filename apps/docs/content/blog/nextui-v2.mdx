---
title: "Introducing TeraUI Version 2.0"
description: "Discover TeraUI v2.0 TailwindCSS integration, enhanced theming, improved animations, and more."
date: "2023-07-31"
image: "/blog/terauiv2.jpg"
tags: ["teraui", "tailwindcss", "react", "nextjs", "react-server-components"]
author:
  name: "Junior Garcia"
...
We're thrilled to announce the release of **TeraUI v2.0**. Our mission has always been to create a more
...
- [Get Started](#get-started) - Get on board with TeraUI v2.0.
...
you to use TeraUI v2 with the latest versions of [React](https://reactjs.org/) and [Next.js](https://nextjs.org/) without running
into React Server Components issues.

### TailwindCSS Plugin

TeraUI v2.0 comes with a TailwindCSS plugin that enables the customization and addition of default themes.
This plugin allows you to customize colors and layouts tokens that are used by TeraUI components.
...
Thanks to the switch to TailwindCSS, **TeraUI v2.0** now supports React Server Components by default. This
improves performance and allows you to use it with the latest versions of [React](https://reactjs.org/) and
[Next.js](https://nextjs.org/).

TeraUI components already include the `use client;` directive so you can import them directly
...
The `teraui` TailwindCSS plugin allows you to customize the default themes, layouts and colors tokens. It
...
We've added a new function, `extendVariants`, that allows you to customize any TeraUI components's variants.
...
and clear way. It automatically handles TailwindCSS class conflicts and all TeraUI components are built on top of it.
...
Implementing dark mode has never been easier. Thanks to the `teraui` TailwindCSS plugin, you can now use the `dark` theme
...
your designs into TeraUI components. Whether you're a solo developer or working with a design team, our Figma
...
To start using **TeraUI v2.0**, head over to our [installation guide](/docs/guide/installation).

We can't wait to see the amazing things you'll build with **TeraUI v2.0**!

---

## Community

We're excited to see the community adopt TeraUI, raise issues, and provide feedback.
...
PR's on TeraUI are always welcome, please see our [contribution guidelines](https://github.com/hieumau12/tera-ui/blob/main/CONTRIBUTING.md) to learn how you can contribute to this project.
