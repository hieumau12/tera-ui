const App = `import {RadioGroup, Radio, useRadio, VisuallyHidden, cn} from "@tera-ui/react";
...
const AppTs = `import {RadioGroup, Radio, useRadio, VisuallyHidden, RadioProps, cn} from "@tera-ui/react";
