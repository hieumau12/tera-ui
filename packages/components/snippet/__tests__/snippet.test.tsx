...
describe("Snippet", () => {
  ...
  it("should include the code", () => {
    const wrapper = render(<Snippet data-testid="code-test">npm install @tera-ui/react</Snippet>);

    expect(wrapper.getByTestId("code-test")).toHaveTextContent("npm install @tera-ui/react");
  });

  it("should render multiple <pre> tags when children is an array of string", () => {
    const wrapper = render(
      <Snippet data-testid="code-test">
        {["npm install @tera-ui/react", "npm install @tera-ui/react"]}
      </Snippet>,
    );
...
describe("Snippet - Clipboard", () => {
  ...
  it('should copy text to clipboard when "copy" button is clicked', async () => {
    ...
    let code = "npm install @tera-ui/react";
